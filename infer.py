...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='test_predictions_cutmix',
        # default='test_predictions-1024-30',
        # default='test_predictions-2048-30',
        # default='test_predictions-2048-100',
        # default='test_predictions-2048-100-large',
